[title]: # (Secret Server Release Notes 11.0.0000xx)
[tags]: # (Release Notes)
[priority]: # (1000)
[display]: # (search,content,print)

# Secret Server: 11.0.0000xx Release Notes

Release date:

- August 17, 2021 (on-premises version)
- August 21, 2021. Release date is dependent on region (cloud version)

>**Important:** These notes cover the General Availability release of version 11.0.0000xx. The general release is not till August 17, 2021 for the on-premises version and August 21,  2021 for the cloud version. If you are not part of the early release program, or are in a Secret Server Cloud region that has not yet received the 10.9.00064 release, please use the [Secret Server 10.9.000064](ss-rn-10-9-000064.md) notes instead.
>
> Updates:
>
>TBD
